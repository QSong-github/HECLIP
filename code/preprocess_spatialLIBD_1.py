...
def hvg_selection_and_pooling(exp_paths, n_top_genes=1000):
    ...
    np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/hvg_union.npy", hvg_union.to_numpy())
...
exp_paths = ["../GSE/spatialLIBD_1/data/filtered_expression_matrices/1/matrix.mtx",
            "../GSE/spatialLIBD_1/data/filtered_expression_matrices/2/matrix.mtx",
            "../GSE/spatialLIBD_1/data/filtered_expression_matrices/3/matrix.mtx",
            "../GSE/spatialLIBD_1/data/filtered_expression_matrices/4/matrix.mtx"]
filtered_mtx = hvg_selection_and_pooling(exp_paths)
for i in range(len(filtered_mtx)):
    np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/" + str(i + 1) + "/hvg_matrix.npy", filtered_mtx[i].T)
...
d = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/1/hvg_matrix.npy")
print(d.shape)

d2 = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/2/hvg_matrix.npy")
print(d2.shape)

d3 = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/3/hvg_matrix.npy")
print(d3.shape)

d4 = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/4/hvg_matrix.npy")
print(d4.shape)

d = np.concatenate((d.T, d2.T, d3.T, d4.T), axis = 0)
print(d.shape)
data_sizes = [3661, 4384, 4789, 4634]
batch_labels = np.concatenate((np.zeros(3661), np.ones(4384), np.ones(4789)*2, np.ones(4634)*3))
...
#save
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/1/harmony_hvg_matrix.npy", d1.T)
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/2/harmony_hvg_matrix.npy", d2.T)
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/3/harmony_hvg_matrix.npy", d3.T)
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/4/harmony_hvg_matrix.npy", d4.T)  #saving gene x cell to be consistent with hvg_matrix.npy
...
def heg_selection_and_pooling(exp_paths, n_top_genes=3200):
    ...
    np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/heg_union.npy", heg_union_series.to_numpy())
...
for i in range(len(filtered_mtx)):
    np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/" + str(i + 1) + "/heg_matrix.npy", filtered_mtx[i].T)
...
d = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/1/heg_matrix.npy")
print(d.shape)

d2 = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/2/heg_matrix.npy")
print(d2.shape)

d3 = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/3/heg_matrix.npy")
print(d3.shape)

d4 = np.load("../GSE/spatialLIBD_1/data/filtered_expression_matrices/4/heg_matrix.npy")
print(d4.shape)
...
#save
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/1/harmony_heg_matrix.npy", d1.T)
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/2/harmony_heg_matrix.npy", d2.T)
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/3/harmony_heg_matrix.npy", d3.T)
np.save("../GSE/spatialLIBD_1/data/filtered_expression_matrices/4/harmony_heg_matrix.npy", d4.T)  #saving gene x cell to be consistent with hvg_matrix.npy
